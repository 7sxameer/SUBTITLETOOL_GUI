...
class VideoSubtitleApp {
    ...
    async executeSteps1And2() {
        ...
        const response = await axios.post(`http://127.0.0.1:${this.backendPort}/process`, 
            processingData, {
    ...
    async executeStep3Apply() {
        ...
        try {
            ...
            const response = await axios.post(`http://127.0.0.1:${this.backendPort}/apply-correction`, 
    ...
    async executeStep3Skip() {
        ...
        try {
            ...
            const response = await axios.post(`http://127.0.0.1:${this.backendPort}/skip-correction`, 
    ...
    async executeStep4() {
        ...
        try {
            ...
            const response = await axios.post(`http://127.0.0.1:${this.backendPort}/burn-subtitles`, 
    ...
    async submitCorrection() {
        ...
        try {
            ...
            const response = await axios.post(`http://127.0.0.1:${this.backendPort}/correct-srt`, 
                correctionRequest, {
